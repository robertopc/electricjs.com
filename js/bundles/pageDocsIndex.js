      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          ie_open('div', null, null,
            ...
            ie_open('div', null, null,
                'class', 'row');
              var childIdList315 = opt_data.page.childIds;
              var childIdListLen315 = childIdList315.length;
              for (var childIdIndex315 = 0; childIdIndex315 < childIdListLen315; childIdIndex315++) {
                var childIdData315 = childIdList315[childIdIndex315];
                var topic__soy305 = opt_data.page.children[childIdData315];
                if (! topic__soy305.hidden) {
                  ie_open('div', null, null,
                      'class', 'col-md-8 col-md-offset-0 col-xs-14 col-xs-offset-1');
                    ie_open('a', null, null,
                        'class', 'topic radial-out',
                        'href', topic__soy305.url);
                      ie_open('div', null, null,
                          'class', 'topic-icon');
                        ie_void('span', null, null,
                            'class', 'icon-16-' + topic__soy305.icon);
                      ie_close('div');
                      ie_open('h3', null, null,
                          'class', 'topic-title');
                        var dyn15 = topic__soy305.title;
                        if (typeof dyn15 == 'function') dyn15(); else if (dyn15 != null) itext(dyn15);
                      ie_close('h3');
                    ie_close('a');
                  ie_close('div');
