...
function $showcase(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
          'class', 'row');
        var showcaseList461 = opt_data.site.showcase;
        var showcaseListLen461 = showcaseList461.length;
        for (var showcaseIndex461 = 0; showcaseIndex461 < showcaseListLen461; showcaseIndex461++) {
          var showcaseData461 = showcaseList461[showcaseIndex461];
          ie_open('div', null, null,
              'class', 'col-xs-16 col-md-8');
            ie_open('div', null, null,
                'class', 'showcase-item');
              ie_open('div', null, null,
                  'class', 'showcase-img-wrapper');
                ie_open('img', null, null,
                    'class', 'showcase-img',
                    'src', '/images/' + showcaseData461.image + '.jpg',
                    'alt', showcaseData461.title);
                ie_close('img');
              ie_close('div');
              ie_open('p', null, null,
                  'class', 'showcase-title');
                var dyn18 = showcaseData461.title;
                if (typeof dyn18 == 'function') dyn18(); else if (dyn18 != null) itext(dyn18);
              ie_close('p');
              ie_open('p', null, null,
                  'class', 'showcase-description');
                var dyn19 = showcaseData461.description;
                if (typeof dyn19 == 'function') dyn19(); else if (dyn19 != null) itext(dyn19);
                ie_open('br');
                ie_close('br');
                ie_open('br');
                ie_close('br');
                ie_open('a', null, null,
                    'href', showcaseData461.site);
                  itext('Visit Site');
                ie_close('a');
                if (showcaseData461.repo) {
                  itext(' | ');
                  ie_open('a', null, null,
                      'href', showcaseData461.repo);
                    itext('Source Code');
                  ie_close('a');
                }
              ie_close('p');
